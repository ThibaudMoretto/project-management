...
import { TASK_STATUSES, TCreateTaskData } from 'project-management-types';
import {
...
function TasksList() {
  ...
  const { register, handleSubmit } = useForm<TCreateTaskData>();
  ...
  const onSubmit = (createTaskData: Omit<TCreateTaskData, 'projectId'>) => {
    if (projectId) {
